...
class Player(Gtk.Window):
    ...
    def __init__(self):
        ...
        # self.pipeline = Gst.parse_launch(f'input-selector name="selector" ! capsfilter name="size" caps="video/x-raw, height=600, width=800, framerate=30/1" ! videoconvert ! \
        #                                   x264enc name="encoder" speed-preset=ultrafast tune=zerolatency bitrate={self.bitrate} ! h264parse ! \
